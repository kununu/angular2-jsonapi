...
var JsonApiDatastore = /** @class */ (function () {
    ...
    JsonApiDatastore.prototype.getRelationships = function (data) {
        ...
        var _loop_1 = function (key) {
            if (data.hasOwnProperty(key)) {
                var value = data[key];
                if (value instanceof json_api_model_1.JsonApiModel) {
                    relationships = relationships || {};
                    if (data[key].id) {
                ...
                else if (value instanceof Array && data[key].length > 0 && this_1.isValidToManyRelation(data[key])) {
                    relationships = relationships || {};
        ...
        this.relationsToBeDeleted(data).forEach(function (toDelete) {
            relationships = relationships || {};
    ...
    JsonApiDatastore.prototype.relationsToBeDeleted = function (model) {
        ...
        return belongsToMetadata == null
            ? []
            : belongsToMetadata.filter(function (entity) { return model.hasOwnProperty(entity.propertyName); })
                .filter(function (entity) { return model[entity.propertyName] === null; })
                .map(function (entity) { return entity.relationship; });
    };
